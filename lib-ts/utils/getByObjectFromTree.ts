export function getByObjectFromTree(obj: object, key: string, searchmode: number, parentkeynames?: boolean): Array<string | any[]> | undefined {
    if (!obj || typeof obj !== "object" || !Object.keys(obj) || !(key ?? undefined)) return undefined;
